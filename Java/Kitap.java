...
public class Kitap {
	...
	public void kitabiGoruntule(){
		System.out.println("\nRapor");
		System.out.println("********");
		System.out.println("Kitap Adý:" + kitap_adi);
		System.out.println("Yazari :" + yazar_adi);
		System.out.println("Sayfa Bilgisi:" + sayfa_sayisi);
		System.out.println("\n");
	}
	...
	public static void main(String[] args) {
		...
		kitap1.kitap_adi = "Puslu Kýtalar Atlasý";
		kitap1.sayfa_sayisi = 238;
		kitap1.yazar_adi = "Ýhsan Oktay Anar";	
